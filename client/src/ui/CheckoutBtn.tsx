    ...
    <div className="mt-6">
      {currentUser ? (
        <button
          ...
          type="submit"
          className="w-full rounded-md border-2 border-transparent bg-primary px-4 py-3 text-base font-medium text-white shadow-sm hover:!bg-white hover:text-red-600 hover:border-red-600 focus:outline-none focus:ring-2 focus:ring-skyText focus:ring-offset-2 focus:ring-offset-gray-50 duration-300 ease-in"
        >
          Checkout
        </button>
      ) : (
